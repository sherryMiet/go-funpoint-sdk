...
import (
	...
	ecpayBase "github.com/sherryMiet/go-funpoint-sdk/base"
	"strconv"
	"strings"
	"time"
)
...
type AioOrderRequest struct {
	...
	*ecpayBase.AioCheckOutCreditInstallmentAmount
...
func (r *AioOrderRequestCreditWithClient) WithCreditInstallmentAmount(amount int) *AioOrderRequestCreditWithClient {
	if r.err != nil {
		return r
	}
	r.request.AioCheckOutCreditInstallmentAmount = &ecpayBase.AioCheckOutCreditInstallmentAmount{
